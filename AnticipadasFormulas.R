...
Tasaperiodo=function(VF,t,A){
  r=(tasaAnualidadVencidaVF(VF,A,t,umbral=10*(10^-17)))(1+r)
  return(r)
}
...
Tasaperodo2=function(VA,t,A){
  r=(tasaAnualidadVencidaVA(VA,A,t,umbral=10*(10^-17)))(1+r)
  return(r)
}
